...
public class MyBank {
  ...
  private TransactionalOperation transactionalOperation;
  ...
  public MyBank() {
    ...
    transactionalOperation = new TransactionalOperation();
  }
  ...
  public void transfer(int fromId, int toId, int amount) {
    ...
    Account toAccount = to.get();
      ...
      transactionalOperation.provideTransactionOn(fromAccount, toAccount, (aFrom, aTo) -> {
